...
import com.jssg.servicemanagersystem.utils.JsonFormatTool
 ...
 */
class HttpLoggerFormatInterceptor @JvmOverloads constructor(
        ...
        if (logHeaders) {
            ...
            if (!logBody || !response.promisesBody()) {
                ...
                if (contentLength != 0L) {
                    ...
                    logger.log(JsonFormatTool.formatJson(message))
                }
