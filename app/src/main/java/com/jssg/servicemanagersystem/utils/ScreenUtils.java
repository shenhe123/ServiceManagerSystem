...
public class ScreenUtils {
    ...
    public static boolean isNavigationBarShow(Activity context) {
        ...
        int heightPixels2 = outMetrics2.heightPixels + getStatusBarHeight(context);//最关键的是这里，内容的高度是不包括顶部状态栏的要加上
        //宽度
    ...
    public static int dp2px(Context context, @DimenRes int dimen_resID) {
        final float scale = context.getResources().getDisplayMetrics().density;
