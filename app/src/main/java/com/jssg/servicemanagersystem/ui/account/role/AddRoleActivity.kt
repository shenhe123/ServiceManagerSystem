...
import com.jssg.servicemanagersystem.databinding.ActivityAddRoleBinding
...
class AddRoleActivity : BaseActivity() {
    ...
    class AddRoleContracts: ActivityResultContract<Any, Boolean?>() {
        override fun createIntent(context: Context, input: Any): Intent {
            return Intent(context, AddRoleActivity::class.java)
        }
