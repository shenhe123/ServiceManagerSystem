...
public class TimeDialogFragment extends BottomSheetDialogFragment implements View.OnClickListener{
    ...
    public static TimeDialogFragment newInstance(PickerOptions pickerOptions) {

        Bundle args = new Bundle();
        args.putParcelable("pickerOptions", pickerOptions);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPickerOptions = ((PickerOptions) getArguments().getParcelable("pickerOptions"));
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.pickerview_time, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        ...
        RelativeLayout rv_top_bar = (RelativeLayout) view.findViewById(R.id.rv_topbar);
        ...
        //设置文字
        btnSubmit.setText(TextUtils.isEmpty(mPickerOptions.textContentConfirm) ? getResources().getString(R.string.pickerview_submit) : mPickerOptions.textContentConfirm);
        btnCancel.setText(TextUtils.isEmpty(mPickerOptions.textContentCancel) ? getResources().getString(R.string.pickerview_cancel) : mPickerOptions.textContentCancel);
        ...
        // 时间转轮 自定义控件
        timePickerView = (LinearLayout) view.findViewById(R.id.timepicker);
    ...
    public void returnData() {
        if (mPickerOptions.timeSelectListener != null) {
            try {
                Date date = WheelTime.dateFormat.parse(wheelTime.getTime());
                mPickerOptions.timeSelectListener.onTimeSelect(date);
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }
